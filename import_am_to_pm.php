...
<div class="container">
	<div class="row" >
		...
		<div class="col-md-12 bg-white" >
			<h4 style="padding:20px; ">Upload AM TO PM	Information </h4>
			<hr />
		</div>
		<div class="col-md-12 bg-white" >  
			 <?php 
				if(isset($_POST['importSubmit'])){ 
					...
					if($_FILES["file"]["size"]> 0){
						...
						while(($column=fgetcsv($file, 10000, ",")) !== FALSE){
							  ...
							  $query ="INSERT INTO `am_to_pm`(`ac`, `name`) values 
										('".$column[0]."','".$column[1]."')";
									...
									<div style="width:650px; margin:0px auto; background:#eee; border:
										3px solid #ff8800; border-radius:5px; margin-top:20px; padding:20px; ">
												<div class="bg-success" style="padding:20px; border-radius:5px;">
													<h5 class="text-white">Succesfully Upload AM To PM Members information </h5>
												</div>
											</div>	
										</div>
									</div>
				...
				<div style="width:650px; margin:0px auto; background:#eee; border:
					...
					<form action="import_am_to_pm.php" method="post" enctype="multipart/form-data">
