...
<main class="page-content">
	<div class="board_marker">
		<h6>Home <i class="fa fa-circle text-warning"></i> Loan Summery Details Info</h6>	
	</div>
	<div class="containter-fluid">
		<div class="row">
			<h6 style="color:#059605; font-weight:bold;">Loan Summery Details Info</h6>
			<div class="col-md-12">
				<div class="card-wrapper" style="margin-top:10px; padding-lef:15px; padding-right:30px; padding-bottom:20px;">
					...
					<br />
						...
						<?php  
							...
							if ($basic1==true){
									while($salary_info1=$basic1->fetch_assoc()){
										 ...
										 $SerivceCharge	= $salary_info1['service_charge'];
							...
							$query2="select * from employee where id='".$getid."'"; 
						...
						<?php }?>
							...
							<a href="employee_info.php?tabid=info" class="btn btn-warning btn-sm text-white ">Back to Employee Table</a>									 
						</div> 
